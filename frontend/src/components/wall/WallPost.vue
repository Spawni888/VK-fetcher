    ...
    <div class="wall-post">
        <div class="profile-info">
            <div class="profile-info__picture">
                <a :href="`https://vk.com/id${profileCopy.id}`" target="_blank">
                    <img :src="profileCopy.photo_400_orig || profileCopy.photo_200_orig || profileCopy.photo_200" alt="profile">
                </a>
            </div>
